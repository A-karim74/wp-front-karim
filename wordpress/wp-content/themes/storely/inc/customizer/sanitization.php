 ...
 */
function storely_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function storely_sanitize_html( $html ) {
 ...
 */
function storely_sanitize_number_absint( $number, $setting ) {
 ...
 */
function storely_sanitize_select( $input, $setting ) {
 ...
 */
function storely_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function storely_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function storely_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}